...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(WorkingSet_0), TYPEID_WORKSET, COLOR(187), 1, ID(DataMask_Home), 1, 0, 2,
		...
		'e', 'n',
		'd', 'e',
	ID(Macro_seite_wechseln), TYPEID_MACRO, WORD(8),
	...
	ID(Button_Seite2), TYPEID_BUTTON, WORD(79), WORD(83), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_11000, -4, 28),
		MACRO(EV_KEYRELEASE, Macro_seite_wechseln),
	ID(Button_Seite1), TYPEID_BUTTON, WORD(114), WORD(112), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_11006, -4, 42),
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_11006), TYPEID_OUTSTR, WORD(114), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
