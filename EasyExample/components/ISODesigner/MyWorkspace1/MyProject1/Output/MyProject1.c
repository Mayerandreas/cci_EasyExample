...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Macro_1), TYPEID_MACRO, WORD(16),
		...
		CMD_CONTROL_AUDIO_DEVICE, 3, WORD(440), WORD(200), WORD(100)
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 10, 0, 
		...
		XYREF(Button_Seite2, 399, 14),
		XYREF(Button_aus, 401, 98),
		XYREF(Button_ein, 403, 178),
	ID(DataMask_2), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 1, 0, 
		XYREF(Button_Seite1, 344, 127),
	...
	ID(Button_Seite2), TYPEID_BUTTON, WORD(77), WORD(78), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_11000, -4, 25),
		MACRO(EV_KEYRELEASE, Macro_1),
	ID(Button_Seite1), TYPEID_BUTTON, WORD(105), WORD(94), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_11006, -4, 33),
		MACRO(EV_KEYRELEASE, Macro_2),
	ID(Button_aus), TYPEID_BUTTON, WORD(70), WORD(63), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_aus, -4, 18),
		MACRO(EV_KEYRELEASE, Macro_3),
	ID(Button_ein), TYPEID_BUTTON, WORD(69), WORD(53), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_11008, -4, 13),
	...
	ID(OutputString_11000), TYPEID_OUTSTR, WORD(77), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(6), 'S', 'e', 'i', 't', 'e', '2', 0,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_11006), TYPEID_OUTSTR, WORD(105), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(6), 'S', 'e', 'i', 't', 'e', '1', 0,
	ID(OutputString_aus), TYPEID_OUTSTR, WORD(70), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'a', 'u', 's', ' ', 0,
	ID(OutputString_11008), TYPEID_OUTSTR, WORD(69), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'e', 'i', 'n', ' ', 0,
