...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 6, 0, 
		...
		XYREF(S2, 397, 73),
	ID(DataMask_2), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 3, 0, 
		XYREF(Container_3002, 222, 93),
		XYREF(Button_D1, 37, 48),
		XYREF(Button_Return, 73, 294),
	...
	ID(Container_3002), TYPEID_CONTAINER, WORD(203), WORD(343), 0, 2, 0, 
		XYREF(Button_S1, 112, 0),
		XYREF(Button_D1, 0, 186),
	...
	ID(S2), TYPEID_BUTTON, WORD(72), WORD(72), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_S2, -4, 22),
		MACRO(EV_KEYRELEASE, Macro_1),
	ID(Button_S1), TYPEID_BUTTON, WORD(91), WORD(83), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_S1, -4, 28),
		MACRO(EV_KEYRELEASE, Macro_S1),
	ID(Button_D1), TYPEID_BUTTON, WORD(174), WORD(157), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_D1, -4, 65),
		MACRO(EV_KEYRELEASE, Macro_D1),
	ID(Button_Return), TYPEID_BUTTON, WORD(110), WORD(109), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_Return, -4, 41),
	...
	ID(OutputString_S2), TYPEID_OUTSTR, WORD(57), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_S1), TYPEID_OUTSTR, WORD(91), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'S', '1', ' ', ' ', 0,
	ID(OutputString_D1), TYPEID_OUTSTR, WORD(174), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(4), 'D', '1', ' ', ' ', 0,
	ID(OutputString_Return), TYPEID_OUTSTR, WORD(110), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
	...
	ID(OutputString_11013), TYPEID_OUTSTR, WORD(62), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(6), 'B', 'u', 't', 't', 'o', 'n', 0,
