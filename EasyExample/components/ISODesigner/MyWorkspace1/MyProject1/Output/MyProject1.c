...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 9, 0, 
		...
		XYREF(Button_seite2, 394, 11),
		XYREF(Button_6006, 400, 110),
	ID(DataMask_2), TYPEID_DATAMASK, COLOR(230), ID(ID_NULL), 1, 0, 
		XYREF(Button_seite1, 324, 60),
	...
	ID(Button_seite2), TYPEID_BUTTON, WORD(80), WORD(80), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_seite2, -4, 17),
		MACRO(EV_KEYRELEASE, Macro_1),
	ID(Button_seite1), TYPEID_BUTTON, WORD(80), WORD(80), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_seite1, -4, 37),
		MACRO(EV_KEYRELEASE, Macro_2),
	ID(Button_6006), TYPEID_BUTTON, WORD(73), WORD(83), 249, 249, 1, 0, 1, 2, 
		XYREF(OutputString_11007, -4, 28),
	...
	ID(OutputString_seite2), TYPEID_OUTSTR, WORD(63), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_seite1), TYPEID_OUTSTR, WORD(101), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(6), 's', 'e', 'i', 't', 'e', '1', 0,
	ID(OutputString_11007), TYPEID_OUTSTR, WORD(80), WORD(80), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 5, WORD(6), 'z', 'ä', 'h', 'l', 'e', 'r', 0,
	...
	ID(LinearBargraph_Gesamtzaehler), TYPEID_OUTLINBAR, WORD(60), WORD(180), COLOR_BLACK, COLOR_RED, 39, 11, 
		WORD(0), WORD(10), ID(NumberVariable_Gesamtzaehler), WORD(0), ID(NumberVariable_Gesamtziel), WORD(0), 0, 
