...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(Macro_wechsel), TYPEID_MACRO, WORD(8),
		CMD_CHANGE_ACTIVE_MASK, ID(WorkingSet_0), ID(DataMask_Seite_2), 0xFF, 0xFF, 0xFF,
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 8, 0, 
		...
		XYREF(Button_S3, 259, 179),
	ID(DataMask_Seite_2), TYPEID_DATAMASK, COLOR(227), ID(ID_NULL), 1, 0, 
		XYREF(Button_S1, 335, 133),
	...
	ID(Button_S3), TYPEID_BUTTON, WORD(100), WORD(100), 6, 8, 1, 0, 1, 1, 
		XYREF(OutputString_11000, -4, 19),
		MACRO(EV_KEYRELEASE, Macro_wechsel),
	ID(Button_S1), TYPEID_BUTTON, WORD(94), WORD(85), 6, 8, 1, 0, 1, 1, 
		XYREF(OutputString_11006, -4, 29),
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(112), WORD(52), COLOR_WHITE, ID(FontAttributes_Default), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_11006), TYPEID_OUTSTR, WORD(94), WORD(20), COLOR_WHITE, ID(FontAttributes_23000), 1,
